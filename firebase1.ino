...
void uploadSensorDataToFirebase() {
  ...
  jsonDoc["heart_rate"] = pulseSensor.getBeatsPerMinute();
  jsonDoc["temperature"] = bmp.temperature;
  jsonDoc["pressure"] = bmp.pressure / 100.0;
  jsonDoc["altitude"] = bmp.readAltitude(SEALEVELPRESSURE_HPA);
  jsonDoc["motion_x"] = sensorValue.un.accelerometer.x;
  jsonDoc["motion_y"] = sensorValue.un.accelerometer.y;
  jsonDoc["motion_z"] = sensorValue.un.accelerometer.z;
  ...
  sendDataToFirebase("sensorData", jsonString);
}
